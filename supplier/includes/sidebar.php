...
<nav class="navbar navbar-inverse navbar-fixed-top"><!-- navbar navbar-inverse navbar-fixed-top begin -->
    <div class="navbar-header"><!-- navbar-header begin -->
        ...
        <a href="index.php?dashboard" class="navbar-brand">Supplier Dashboard</a>
        ...
        <ul class="nav navbar-nav side-nav"><!-- nav navbar-nav side-nav begin -->
            ...
            <li><!-- li begin -->
                <a href="#" data-toggle="collapse" data-target="#products"><!-- a href begin -->
                        ...
                        <i class="fa fa-fw fa-tag"></i> Register
                ...
                <ul id="products" class="collapse"><!-- collapse begin -->
                    <li><!-- li begin -->
                        <a href="index.php?register_company"> Register </a>
                    </li><!-- li finish -->
                    <li><!-- li begin -->
                        <a href="index.php?view_company_details"> View details </a>
                    </li><!-- li finish -->
                </ul><!-- collapse finish -->
            ...
            <li><!-- li begin -->
                <a href="#" data-toggle="collapse" data-target="#p_cat"><!-- a href begin -->
                        ...
                        <i class="fa fa-fw fa-edit"></i> Catalogue
                        <i class="fa fa-fw fa-caret-down"></i>
                ...
                <ul id="p_cat" class="collapse"><!-- collapse begin -->
                    <li><!-- li begin -->
                        <a href="index.php?add_items"> Add Items </a>
                    </li><!-- li finish -->
                    <li><!-- li begin -->
                        <a href="index.php?view_catalogue_items"> View Items </a>
                    </li><!-- li finish -->
                </ul><!-- collapse finish -->
            ...
            <li><!-- li begin -->
                <a href="#" data-toggle="collapse" data-target="#slides"><!-- a href begin -->
                        ...
                        <i class="fa fa-fw fa-gear"></i> RFQs
                        <i class="fa fa-fw fa-caret-down"></i>
                ...
                <ul id="slides" class="collapse"><!-- collapse begin -->
                    <li><!-- li begin -->
                        <a href="index.php?runing_rfq"> Running RFQs </a>
                    </li><!-- li finish -->
                    <li><!-- li begin -->
                        <a href="index.php?view_slides"> Completed RFQs</a>
                    </li><!-- li finish -->
                </ul><!-- collapse finish -->
